...
public class LowestAverageRating {

	public static class StarRartingMap extends Mapper<Object, Text, Text, DoubleWritable>{
		 ...
		 public static void main(String[] args) throws Exception {
			    ...
			    Job job = Job.getInstance(conf, "Lowest Average Rating");
			    job.setJarByClass(LowestAverageRating.class);
			    job.setMapperClass(StarRartingMap.class);
